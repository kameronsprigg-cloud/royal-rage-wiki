...
| Position | Role | Examples | Doctrine |
| :--- | :--- | :--- | :--- |
...
## 2. Skill Levelling Order
Skills get expensive fast. Do not spread resources evenly; prioritize your **Ace** first. 

1.  **Active Skill (Slot 2):** Highest priority.
2.  **Passive Skill (Slot 3):** Second priority.
3. **Basic Attack (Slot 1):** Lowest priority. 

---

## 3. Team Synergy (The Vibe Check)
Heroes perform better with their friends. Mixing types haphazardly drags the team down. 

| Composition | Bonus Stats | Rating |
| :--- | :--- | :--- |
| **5 of a Kind** | **+20% HP/ATK/DEF** | **Elite** (Goal) |
| **4 of a Kind** | +15% (to the 4) | Great |
| **3 + 2 Split** | +10% (to all) | Decent |
| **3 Split** | +5% | Poor |
| **2 + 2 + 1** | +0% | **F-Tier** (Do not do this) |
